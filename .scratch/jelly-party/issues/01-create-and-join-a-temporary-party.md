...
- [x] The in-memory backend validates bounded protocol messages, maintains ephemeral party presence, exposes a health endpoint, and production clients connect only to `wss://v2.jelly-party.com`.
