...
Jelly Party 2.1 is built entirely from the checked-in TypeScript and Svelte sources with Vite+.
...
The Firefox extension is `artifacts/jelly-party-2.1.0-firefox.zip`. The build task validates the
