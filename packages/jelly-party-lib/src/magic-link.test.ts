...
describe("magic links", () => {
  ...
  it.each([
    `https://join.jelly-party.com/?party=${partyId}&video=javascript%3Aalert(1)`,
    `https://join.jelly-party.com/?party=bad&video=https%3A%2F%2Fvideo.test%2Fwatch`,
    `https://join.jelly-party.com/?party=${partyId}&video=https%3A%2F%2Fuser%3Apass%40video.test%2Fwatch`,
    `https://join.jelly-party.com/?party=${partyId}`,
