...
export const config: Config = {
  wsUrl: typeof __JELLY_WS_URL__ !== "undefined" ? __JELLY_WS_URL__ : "ws://localhost:8080",
  joinUrl: typeof __JELLY_JOIN_URL__ !== "undefined" ? __JELLY_JOIN_URL__ : "http://localhost:5180",
  websiteUrl:
